...
4. Repository baru untuk web dinamis di docker hub 

![alt text](image.png)

5. Buka Projeck Company himafor_nim
...
9. Lakukan Testing di Local Project Next.JS
    ...
    - Create user di DBMS : sudo mysql -u root -p
        -  CREATE USER 'userwebdinamis_2388010031'@'localhost' IDENTIFIED BY 'apJG]QGtLZR!k_JA';
        - GRANT ALL PRIVILEGES ON *.* TO 'userwebdinamis_2388010031'@'localhost';
        - FLUSH PRIVILEGES;
        - exit;
